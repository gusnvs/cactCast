<?php
	// esta classe irá conter todas as Strings de erro
	class Constants{

		public static $tamanhoSenha = "Sua senha deve conter entre 5 e 25 caracteres.";
		...
		public static $usernameExist = "Este usuário já existe!";
		public static $emailExist = "Este email já está cadastrado!";
		public static $loginFailed = "Seu usuário ou senha estão incorretos!";
	}
?>